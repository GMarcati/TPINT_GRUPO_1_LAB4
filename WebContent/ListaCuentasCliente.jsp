...
<thead >
		...
		<tr>
			...
			<a href="servletMovimientos?idCuenta=<%=cuenta.getIdCuenta()%>&numeroCuenta=<%=cuenta.getNumeroCuenta() %>" class="btn btn-secondary btn-sm" style="width: 100px;">Movimientos</a> <br><br> 
			</td>
		</tr>
